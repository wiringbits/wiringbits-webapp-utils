...
class FormDataSpec extends AnyWordSpec {
  ...
  "fieldsError" should {
    ...
    "return an error when there are invalid optional fields" in {
      val expected = Some("The optional fields need to be either absent or be valid")
      val data = FakeFormData(fields =
